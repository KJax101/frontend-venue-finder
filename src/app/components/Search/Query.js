...
export class Query extends React.Component {
	...
	handleSubmit(event) {
		...
		this.props.fetchVenues(this.state.keyword, this.state.zipCode, this.state.radius);
								...
								<form onSubmit={this.handleSubmit}>
									<div className="form-group">
					                    ...
					                    <h4><strong>Radius (miles)</strong></h4>
										  <select className="form-control select-radius" id="radius" value={this.state.radius} onChange={this.handleChange}>
										    <option>5</option>
										    <option>10</option>
										    <option>20</option>
										    <option>30</option>
